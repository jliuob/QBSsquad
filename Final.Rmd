...
head(pandemic.CO2)
colnames(pandemic.CO2)[1] <- "Country"
```
...
barplot(tapply(pandemic.CO2$CO2.emission..Tons., format(pandemic.CO2$Year), FUN=sum), 
        xlab = "Year",
        ylab = "CO2 Emission Tons",
        main = "Global Cumulative CO2 Emission During Pandemic Years",
        col="#69b3a2")
```
...
ggplot(df.top5, aes(x = Year, y = CO2.emission..Tons., color = Country)) +
  xlab("Year")+
  ylab("CO2 Emission Tons")+
  ggtitle("Cumulative CO2 Emission During Pandemic Years in top5 CO2 Emission Countries")+
...
co2.gr <- c(a,b,c)
plot(co2.gr, type = "line", xlab = "Year Gap", ylab = "Absolute CO2 Growth", main = "Global Absolute CO2 Growth in Pandemic Years")
```
...
CO2_forecasting<-CO2 %>% select(Country, Year, CO2.emission..Tons.)
...
# Save the plots 
ggsave("US.scaled.png",US.plot,width = 10,height = 7.5)
ggsave("UK.scaled.png",UK.plot,width = 10,height = 7.5)
ggsave("GE.scaled.png",GE.plot,width = 10,height = 7.5)
ggsave("CH.scaled.png",CH.plot,width = 10,height = 7.5)
ggsave("RU.scaled.png",RU.plot,width = 10,height = 7.5)
ggsave("FR.scaled.png",FR.plot,width = 10,height = 7.5)
```
